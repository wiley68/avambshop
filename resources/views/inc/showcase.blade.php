	...
	<div class="carousel-inner">
		<div class="carousel-item active">
			...
			<div class="carousel-caption d-none d-md-block">
				<h1 style="font-weight:bold;font-size:42px;">{{ $slide1->name }}</h1>
				<h2 style="font-size:28px;">{{ $slide1->text }}</h2>
		...
		<div class="carousel-item">
			...
			<div class="carousel-caption d-none d-md-block">
				<h1 style="font-weight:bold;font-size:42px;">{{ $slide2->name }}</h1>
				<h2 style="font-size:28px;">{{ $slide2->text }}</h2>
		...
		<div class="carousel-item">
			...
			<div class="carousel-caption d-none d-md-block">
				<h1 style="font-weight:bold;font-size:42px;">{{ $slide3->name }}</h1>
				<h2 style="font-size:28px;">{{ $slide3->text }}</h2>
